...
var IframeView = function () {
	...
	_createClass(IframeView, [{
		...
		value: function render(request, show) {
			...
			return this.sectionRender.then(function (contents) {
				...
				const elementt=	this.document.querySelectorAll('.galley-rw')

					elementt.forEach((element) => {
						element.classList.remove('galley-rw');
					  });

				this.document.body.style.color="black";
				this.document.body.setAttribute('style', `font-family:"DejaVuSerifCondensed", serif `)
				this.document.body.style.fontWeight="normal";
				this.document.body.style.lineHeight="1.3em"
	...
	{
		key: "highlight",
		value: function highlight(cfiRange,color) {
			var _this3 = this;
...
var Themes = function () {
  ...
  */
   ...
   */
		...
		key: "lineHeight",
		value: function lineHeight(LH) {
			this.override("line-height", LH);
